...
class SimpleListingPDFGenerator {
    ...
    private function build_html($data, $qr_code) {
        ...
        <table style="width: 100%%; background-color: #004D43; border-radius: 5px; margin-bottom: 4px;">
            <tr>
                <td style="height: 80px; padding: 0 20px; text-align: center; color: white; font-size: 18pt; font-weight: bold; vertical-align: middle;">
                    %s
                </td>
            </tr>
        </table>
        ...
        if ($data['hero_image']) {
            ...
            <div style="margin: 4px 0;">
                <table style="width: 100%%; border-collapse: collapse;">
                    <tr>
                        <td style="width: 30%%; vertical-align: middle; text-align: center; padding-right: 12px;">
